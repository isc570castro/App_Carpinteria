...
if ($usuario != 'admin'){
    header ('Location: burosU.php');
}
$usuario = $_SESSION['login'];
include "../../../model/conexion.php";
$objConex = new Conexion();
$link=$objConex->conectarse();
$sql = mysql_query("SELECT * FROM catalogo WHERE categoria='buros';" , $link) or die(mysql_error());
$sql2 = mysql_query("SELECT * FROM catalogo WHERE categoria='buros';" , $link) or die(mysql_error());
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-inverse" id="nav">
 <div class="container">
  <div class="container-fluid">
    ...
    <label class="gsubtitulo2">Catálogo > Categoría > Buros</label> 
    </div>
    </td>
      <br>
    </tr>
  ...
  <div class="thumbnail">
    ...
    <p id="eliminar"><a href="eliminarFoto.php?idCatalogo=<?php echo $imagenes['idCatalogo'];?>&ubicacion=buros" class="btn btn-default" role="button" id="btnEliminar">Eliminar</a></p>
    </center>
    </div>
    </div>
  </div>
