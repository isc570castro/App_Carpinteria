...
if (!isset($seguridad)){
header ('Location: escritoriosU.php');
}
$usuario = $_SESSION['login'];
include "../../../model/conexion.php";
$objConex = new Conexion();
$link=$objConex->conectarse();
$sql = mysql_query("SELECT * FROM catalogo WHERE categoria='escritorios';" , $link) or die(mysql_error());
$sql2 = mysql_query("SELECT * FROM catalogo WHERE categoria='escritorios';" , $link) or die(mysql_error());
?>
<!DOCTYPE html>
<html>
<head>
 ...
 <div class="container">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      if($usuario=='admin'){
        echo ' 
         <li><a href="subirFoto.php"><b>Subir foto</b></a></li>';
       } ?>
      ...
      if($usuario=='admin'){
        echo '
      <li><a href="../admin/menuadmin.php"><span class="glyphicon glyphicon-briefcase" aria-hidden="true">&nbsp;</span>Administración</a></li>
        ';
      }else{
        echo'
      <li><a href="../servicio.php"><span class="glyphicon glyphicon-envelope" aria-hidden="true">&nbsp;</span>Pedir servicio</a></li>
      ';
      }
      ?>
      </ul>
    ...
    <label class="gsubtitulo2">Catálogo > Categoría > Escritorios</label> 
    </div>
    </td>
      <br>
    </tr>
  ...
  <div class="thumbnail">
    <img src="<?php echo $ruta;?>" style="width:100%" onClick="openModal();currentSlide(<?php echo $i; ?>)" class="hover-shadow cursor">
     <div class="caption">
     <center>
    <p id="eliminar"><a href="eliminarFoto.php?idCatalogo=<?php echo $imagenes['idCatalogo'];?>&ubicacion=escritorios" class="btn btn-default" role="button" id="btnEliminar">Eliminar</a></p>
    </center>
    </div>
    </div>
  </div>
