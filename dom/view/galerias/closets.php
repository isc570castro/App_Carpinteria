...
if (!isset($seguridad)){
header ('Location: closetsU.php');
}
$usuario = $_SESSION['login'];
include "../../../model/conexion.php";
$objConex = new Conexion();
$link=$objConex->conectarse();
$sql = mysql_query("SELECT * FROM catalogo WHERE categoria='closets';" , $link) or die(mysql_error());
$sql2 = mysql_query("SELECT * FROM catalogo WHERE categoria='closets';" , $link) or die(mysql_error());
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-inverse" id="nav">
 <div class="container">
  <div class="container-fluid">
    ...
    <label class="gsubtitulo2">Catálogo > Categoría > Closets</label> 
    </div>
    </td>
      <br>
    </tr>
  ...
  <div class="thumbnail">
    <img src="<?php echo $ruta;?>" style="width:100%" onClick="openModal();currentSlide(<?php echo $i; ?>)" class="hover-shadow cursor">
     <div class="caption">
     <center>
    <p id="eliminar"><a href="eliminarFoto.php?idCatalogo=<?php echo $imagenes['idCatalogo'];?>&ubicacion=closets" class="btn btn-default" role="button" id="btnEliminar">Eliminar</a></p>
    </center>
    </div>
    </div>
  </div>
