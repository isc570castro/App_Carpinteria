...
$sql = mysql_query("SELECT * FROM catalogo WHERE categoria='cocinas';" , $link) or die(mysql_error());
$sql2 = mysql_query("SELECT * FROM catalogo WHERE categoria='cocinas';" , $link) or die(mysql_error());
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-inverse" id="nav">
 <div class="container">
  <div class="container-fluid">
    ...
    <label class="gsubtitulo2">Catálogo > Categoría > Cocinas</label> 
    </div>
    </td>
      <br>
    </tr>
