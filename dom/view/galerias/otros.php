...
if ($usuario != 'admin'){
header ('Location: otrosU.php');
}
$usuario = $_SESSION['login'];
include "../../../model/conexion.php";
$objConex = new Conexion();
$link=$objConex->conectarse();
$sql = mysql_query("SELECT * FROM catalogo WHERE categoria='otros';" , $link) or die(mysql_error());
$sql2 = mysql_query("SELECT * FROM catalogo WHERE categoria='otros';" , $link) or die(mysql_error());
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-inverse" id="nav">
 <div class="container">
  <div class="container-fluid">
    ...
    <label class="gsubtitulo2">Catálogo > Categoría > Otros</label> 
    </div>
    </td>
      <br>
    </tr>
  ...
  <div class="thumbnail">
    ...
    <p id="eliminar"><a href="eliminarFoto.php?idCatalogo=<?php echo $imagenes['idCatalogo'];?>&ubicacion=otros" class="btn btn-default" role="button" id="btnEliminar">Eliminar</a></p>
    </center>
    </div>
    </div>
  </div>
