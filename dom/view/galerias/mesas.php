...
<nav class="navbar navbar-inverse" id="nav">
 <div class="container">
  ...
  <div class="thumbnail">
    ...
    <p id="eliminar"><a href="eliminarFoto.php?idCatalogo=<?php echo $imagenes['idCatalogo'];?>&ubicacion=mesas" class="btn btn-default" role="button" id="btnEliminar">Eliminar</a></p>
    </center>
    </div>
    </div>
  </div>
