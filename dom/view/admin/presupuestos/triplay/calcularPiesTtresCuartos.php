...
$sql = mysql_query("SELECT * FROM materiaPrima where idPresupuesto='$idPresupuesto' and tipoMadera='triplayTresCuartos';" , $link) or die(mysql_error());
...
<div class="col-md-9 col-md-offset-2">
  <form class="registro" action="../../../../../controller/Presupuestos/triplay/registraTriplayTresCuartos.php?idPresupuesto=<?php echo $idPresupuesto;?>" method="POST" enctype="multipart/form-data" name="frmaltaPresupuesto">
    <h1>Cálculo de pies de triplay de 3/4"</h1>
    <legend></legend>
        ...
        <tr align="center">
          <tr align="center">
            ...
            while ($rows = mysql_fetch_array($sql)){
             ...
             <td align="center"><a href="../../../../../controller/presupuestos/triplay/bajaRegistroTriplay.php?noRegistro=<?php echo $rows ['noRegistro'];?>&idPresupuesto=<?php echo $idPresupuesto; ?>&tipoMadera=triplayTresCuartos"><span class="glyphicon glyphicon-trash"></span></a></td>
           </tr>
           <?php  
         }
         ?>
