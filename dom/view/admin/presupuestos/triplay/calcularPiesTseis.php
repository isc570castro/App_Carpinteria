...
$sql = mysql_query("SELECT * FROM materiaPrima where idPresupuesto='$idPresupuesto' and tipoMadera='triplaySeis';" , $link) or die(mysql_error());
...
<div class="col-md-9 col-md-offset-2">
  <form class="registro" action="../../../../../controller/Presupuestos/triplay/registraTriplaySeis.php?idPresupuesto=<?php echo $idPresupuesto;?>" method="POST" enctype="multipart/form-data" name="frmaltaPresupuesto">
    <h1>Cálculo de pies de triplay de 6 mm</h1>
    <legend></legend>
        ...
        <tr align="center">
          <tr align="center">
            ...
            while ($rows = mysql_fetch_array($sql)){
             ...
             <td align="center"><a href="../../../../../controller/presupuestos/triplay/bajaRegistroTriplay.php?noRegistro=<?php echo $rows ['noRegistro'];?>&idPresupuesto=<?php echo $idPresupuesto; ?>&tipoMadera=triplaySeis"><span class="glyphicon glyphicon-trash"></span></a></td>
           </tr>
           <?php  
         }
         ?>
