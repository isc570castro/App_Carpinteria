        ...
        <tr align="center">
          <tr align="center">
            ...
            while ($rows = mysql_fetch_array($sql)){
             ...
             <td align="center"><a href="../../../../controller/presupuestos/triplay/bajaRegistroTriplayTres.php?noRegistro=<?php echo $rows ['noRegistro'];?>&idPresupuesto=<?php echo $idPresupuesto; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
           </tr>
           <?php  
         }
         ?>
