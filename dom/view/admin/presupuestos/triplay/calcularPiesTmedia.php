...
$sql = mysql_query("SELECT * FROM materiaPrima where idPresupuesto='$idPresupuesto' and tipoMadera='triplayMedia';" , $link) or die(mysql_error());
...
<div class="col-md-9 col-md-offset-2">
  <form class="registro" action="../../../../../controller/Presupuestos/triplay/registraTriplayMedia.php?idPresupuesto=<?php echo $idPresupuesto;?>" method="POST" enctype="multipart/form-data" name="frmaltaPresupuesto">
    <h1>Cálculo de pies de triplay de 1/2"</h1>
    <legend></legend>
