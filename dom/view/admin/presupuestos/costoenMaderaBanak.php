...
$sql = mysql_query("SELECT * FROM materiaPrima where idPresupuesto='$idPresupuesto' and tipoMadera='banak';" , $link) or die(mysql_error());
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
       ...
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a target="_bank" href="../reportes/reportemadera.php?idPresupuesto=<?php echo $idPresupuesto;?>&tipoMadera=BANAK">Reporte</a></li>
        </ul>
      </li>
...
<div class="col-md-11 col-md-offset-1">
  <form class="registro" action="../../../../controller/Presupuestos/registraMaderaBanak.php?idPresupuesto=<?php echo $idPresupuesto;?>" method="POST" enctype="multipart/form-data" name="frmaltaPresupuesto">
    <h1>Cálculo de pies de Banak</h1>
    <legend></legend>
        ...
        <tr align="center">
          <tr align="center">
            ...
            while ($rows = mysql_fetch_array($sql)){
             ...
             <td align="center"><a href="../../../../controller/presupuestos/bajaRegistroMaderaBanak.php?noRegistro=<?php echo $rows ['noRegistro'];?>&idPresupuesto=<?php echo $idPresupuesto; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
           </tr>
           <?php  
         }
         ?>
