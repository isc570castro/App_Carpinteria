...
$sql = mysql_query("SELECT * FROM presupuesto, clientes WHERE clientes.idCliente=presupuesto.idCliente and presupuesto.descripcion like '%$nombre%';" , $link) or die(mysql_error());
?> 
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="col-md-5"></div>
   ...
   <br>
     ...
     <div class="form-group" id="buscar">
      <input type="text" class="form-control" placeholder="Buscar por descripcion" name="nombre" value="<?php echo $nombre;?>"> 
     </div>
...
<div class="row">
  ...
  <thead>
    <tr class="success" >
      <td width=28%><b>Descripción del presupuesto</b></td> <td width=15%><b>Cliente</b></td><td align="right"><b>Costo en madera</b></td><td align="right"><b>Costo en productos</b></td><td align="right" width=14%><b>Monto total</b></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="Left" width="5%" colspan="2"><b>Opciones</b></td>
  <tbody>
    <tr>
    <?php
   ...
   <span class="glyphicon glyphicon-new-window"></span></a></td>
    ...
    <td align="center"><a href="../../../../controller/presupuestos/bajaPresupuesto.php?idPresupuesto=<?php echo $rows['idPresupuesto']; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
     <td align="right">
      <a href="../ventas/generarVenta.php?idPresupuesto=<?php echo $rows ['idPresupuesto']; ?>">
