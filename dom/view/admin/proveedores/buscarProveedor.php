    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a href="buscarProveedor.php">Abono</a></li>
  ...
  <div class="col-md-4"></div>
   ...
   <br>
     ...
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por nombre de producto" name="nombre" value="<?php echo $nombre;?>">
     </div>
...
$sql = mysql_query("SELECT * FROM proveedores where nombreProveedor like '%$nombre%';" , $link) or die(mysql_error());
...
<div class="row">
  ...
  <tbody>
    <tr>
      ...
      <td align="center"><a href="../../../../controller/Proveedores/bajaProveedores.php?idProveedor='. $rows['idProveedor'] .'"><span class="glyphicon glyphicon-trash"></span></a></td>
      </tr>
     ';
}
echo '
