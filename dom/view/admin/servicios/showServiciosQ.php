    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a href="showServiciosQ.php">Abono</a></li>
  ...
  <div class="col-md-4"></div>
   ...
   <br>
     ...
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por usuario" name="usuario" value="<?php echo $usuario; ?>">
     </div>
...
$sql = mysql_query("SELECT * FROM servicios WHERE Usuario='$usuario';" , $link) or die(mysql_error());
echo ' 
<div class="row">
