    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a href="buscarCliente.php">Abono</a></li>
...
<div class="col-md-10 col-md-offset-1" id="fondo">
 <div class="row">
  ...
  <div class="col-md-5"><br><h2>Sección de Clientes</h2>
  </div>
  <div class="col-md-6">
  <div class="col-md-4"></div>
   <div class="col-md-8">
   <br>
      <form class="navbar-form navbar-left" role="search" id="buscar" action="buscarCliente.php" method="POST">
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por nombre de cliente" value="<?php echo $nombre;?>" name="nombre">
     </div>
...
$sql = mysql_query("SELECT * FROM clientes WHERE nombreCliente like '%$nombre%';" , $link) or die(mysql_error());
