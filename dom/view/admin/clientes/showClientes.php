...
<div class="col-md-10 col-md-offset-1" id="fondo">
 <div class="row">
  ...
  <div class="col-md-4"></div>
   <div class="col-md-8">
   <br>
      <form class="navbar-form navbar-left" action="buscarCliente.php" method="POST" role="search" id="buscar">
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por nombre de cliente" name="nombre">
     </div>
