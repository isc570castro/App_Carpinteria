    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
       ...
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="showClientes.php">Abono</a></li>
...
<div class="row">
 <div class="col-md-10 col-md-offset-1" id="fondo">    
   <form class="navbar-form navbar-left" action="" method="POST" role="search" id="buscar" accept-charset="utf-8">
     <div class="row">
      <div class="col-md-5 col-md-offset-1"><br><h2>Sección de clientes</h2></div>


      <div class="col-md-5 ">

        <div class="input-group">
         <input style="width: 100%;" type="text" class="form-control" placeholder="Buscar por nombre de cliente" type="text" name="busqueda" id="busqueda" value="" placeholder="" maxlength="30" autocomplete="off" onKeyUp="buscar();">
         <span class="input-group-btn">

          <button class="btn btn-default" type="button" id="search" onclick="limpiarBuscador();">Todos los clientes</button>
        </span>
      </form>
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->  
