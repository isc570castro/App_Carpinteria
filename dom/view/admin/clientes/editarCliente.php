...
$sql = mysql_query("SELECT * FROM clientes where idCliente='$idCliente';" , $link) or die(mysql_error());
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a href="editarCliente.php">Abono</a></li>
...
<div class="row">
  ...
  <form class="frmRegistro" action="../../../../controller/clientes/actualizarClientes.php?idCliente=<?php echo $idCliente;?>" method="POST" enctype="multipart/form-data" name="frmaltaClientes" id="frmRegistro">
  <h1>Registro de clientes</h1>
  <legend></legend>
    <legend><font size="5"> Datos del cliente: </font></legend>
      <div class="form-group row">
     <div class="form-group has-feedback">
  <label for="example-search-input" class="col-xs-2 col-md-1 col-form-label">Nombre</label>
  <div class=" col-xs-10 col-md-11">
   <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
    <input class="form-control" type="text" id="nombre" placeholder="Nombre" name="nombreCliente" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+" value="<?php echo $rows['nombreCliente']?>">
  </div> 
</div>
</div>
</div>
