    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a href="buscarProducto.php">Abono</a></li>
  ...
  <div class="col-md-4"></div>
   ...
   <br>
     ...
     <div class="form-group">
      <input type="text" class="form-control" placeholder="Buscar por nombre" name="nombre" value="<?php echo $nombre;?>">
     </div>
...
$sql = mysql_query("SELECT * FROM productos  where descripcion like '%$nombre%';" , $link) or die(mysql_error());
